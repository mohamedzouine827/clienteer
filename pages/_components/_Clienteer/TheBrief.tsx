                    ...
                    <div className="self-stretch justify-start items-center gap-16 inline-flex">
                        <div className="grow shrink basis-0 p-6 bg-amber-50 rounded-[37px] border border-amber-200 flex-col justify-start items-start gap-16 inline-flex">
                            ...
                            <div className="self-stretch">
                                ...
                                <span className="text-black text-base font-medium"><br /></span>
                                <h1 className="text-black text-xl font-semibold">Key Deliverables<br /></h1>
                                <span className="text-black text-base font-medium"><br /></span>
                                <span className="text-zinc-600 text-base font-medium">
                                    ...
                                    Style Guide: A comprehensive guide detailing the color scheme, typography, iconography, and other visual elements.<br />
                                ...
                                <span className="text-black text-base font-medium"><br /></span>
                                <h1 className="text-black text-xl font-semibold">Project Timeline<br /></h1>
                                <span className="text-black text-base font-medium"><br /></span>
                                <span className="text-zinc-600 text-base font-medium">
                                ...
                                <span className="text-black text-base font-medium"><br /></span>
                                <h1 className="text-black text-xl font-semibold">Budget<br /></h1>
                                <span className="text-black text-base font-medium"><br /></span>
                                <span className="text-zinc-600 text-base font-medium">
                                ...
                                <span className="text-black text-base font-medium"><br /></span>
                                <h1 className="text-black text-xl font-semibold">Next Steps<br /></h1>
                                <span className="text-black text-base font-medium"><br /></span>
                                <span className="text-zinc-600 text-base font-medium">
